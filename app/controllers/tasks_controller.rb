class TasksController < ApplicationController
  ...
  def report_todo
    @tasks = Task.find(:all, :conditions => [ "status_id = 3 OR (status_id = 2 AND estimated_start_date <= ?)", 7.days.from_now ], :order => "owner,category_id, project_name, title, finish_date")
